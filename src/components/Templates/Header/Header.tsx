...
export function Header() {
  ...
  return (
    <div className="flex items-center ml-0 lg:ml-[100px]">
      <div
      ...
      >
        <div className="mr-25 sm:mr-0">
          <Image
            src={Logo}
            className="h-10 md:h-15 lg:h-full"
        ...
        <div className="nav_buttons hidden sm:flex">
          <nav className="">
            <ul className="flex gap-[30px] mr-[31px]">
              <li>
                <Link href="" className="3xl:text-3xl">
                  Home
                </Link>
              </li>
              <li>
                <Link href="#about" className="3xl:text-3xl">
                  Sobre
                </Link>
              </li>
              <li>
                <Link href="#products" className="3xl:text-3xl">
                  Produtos
                </Link>
              </li>
              <li>
                <Link href="#contact" className="3xl:text-3xl">
                  Contato
                </Link>
              </li>
            </ul>
      ...
      <div className="sm:hidden">
        ...
        <div
          className={`${isOpen ? "absolute right-0 top-0 bg-black h-screen w-[90%] transition-opacity linear duration-1000 opacity-100" : "opacity-0"}`}
        >
          <nav>
            <ul className={`${isOpen ? "flex flex-col gap-5 p-10" : "hidden"}`}>
              <li onClick={menuHamburguer}>X</li>
              <li>
