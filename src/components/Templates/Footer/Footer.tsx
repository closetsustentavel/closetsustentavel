  ...
  return (
    <div id="contact" className="mt-30">
      <div className="flex flex-col justify-center items-center w-screen gap-5">
        <div className="flex flex-col justify-center items-center gap-3" data-aos="fade-right">
          <Image alt="logo" src={Logo} className="h-15 md:h-full"></Image>
          <span>
            <h3 className="text-1xl inline md:text-3xl font-extrabold">Substitua consumo</h3>
        ...
        <div className="pt-5 text-center sm:w-1/2 lg:w-full" data-aos="fade-right">
        ...
        <div className="flex flex-col justify-center items-center" data-aos="fade-right">
          <p>siga-nos</p>
          <Link href="https://www.instagram.com/closetssa_" target="_blank" data-aos="fade-right">
            {" "}
            <Image alt="instagramLogo" src={Instagram}></Image>
          </Link>
        </div>
        <div className="text-center flex flex-col justify-center" data-aos="fade-right">
